...
void Zprime2muCompositeCandidatePicker::produce(edm::Event& event, const edm::EventSetup& setup) {
  ...
  // Sort candidates so we keep either the ones with the higher-pT
  ...
  // Remove lower-ranking cands that are comprised of a lepton that
  // has been used by a higher-ranking one.
