...
samples = [
    ...
    #sample('dy50', 'DY50', '/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v3/AODSIM',  
     #      9000,  37, 1., 6104,    k_factor=1.), ## another quoted value for XS 5943.2
    sample('dy100-200', 'DY100-200', '/DYJetsToLL_M-100to200_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/AODSIM', 
           101638,  38, 1., 226,    k_factor=1.),
    sample('dy200-400', 'DY200-400', '/DYJetsToLL_M-200to400_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/AODSIM', 
           96310,  39, 1., 7.67,    k_factor=1.),
    sample('dy400-500', 'DY400-500', '/DYJetsToLL_M-400to500_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/AODSIM',
           98441,  40, 1., 0.423,    k_factor=1.),
    sample('dy500-700', 'DY500-700', '/DYJetsToLL_M-500to700_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/AODSIM', 
           101029,  41, 1., 0.24,    k_factor=1.),
    sample('dy700-800', 'DY700-800', '/DYJetsToLL_M-700to800_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/AODSIM', 
           96011,  42, 1., 0.035,   k_factor=1.),
    ...
    sample('WW', 'Inclusive-WW', '/WW_TuneCUETP8M1_13TeV-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/AODSIM',  
           697656,  3, 1., 63.21,   k_factor=1.),
    # sample('WZ', 'Inclusive-WZ', '/WZ_TuneCUETP8M1_13TeV-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/AODSIM',
    #0,  2, 1., 22.82,   k_factor=1.),
    sample('ZZ', 'Inclusive-ZZ', '/ZZ_TuneCUETP8M1_13TeV-pythia8/RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v3/AODSIM',
           996944,  4, 1., 10.32,   k_factor=1.)
    ]
...
#dy200-400.ana_dataset = '/DYJetsToLL_M-200to400_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/federica-%s-f646da20575c2cb2b2eda7b4413fb91e/USER'  % (sample.name)
#dy400-500.ana_dataset = '/DYJetsToLL_M-400to500_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/federica-%s-f646da20575c2cb2b2eda7b4413fb91e/USER'  % (sample.name)
...
#WZ.ana_dataset = '/WZ_TuneCUETP8M1_13TeV-pythia8/federica-%s-f646da20575c2cb2b2eda7b4413fb91e/USER'  % (sample.name)
# ZZ.ana_dataset = '/ZZ_TuneCUETP8M1_13TeV-pythia8/federica-%s-/USER'  % (sample.name)
...
#ttbar.ana_dataset = '/RelValTTbar_13/federica-ttbar-8613b30987dd6a37bceba633a6fea3c5/USER'
