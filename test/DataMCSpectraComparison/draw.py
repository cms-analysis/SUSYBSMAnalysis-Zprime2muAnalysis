...
#        self.cutsets = ['VBTF', 'OurNew', 'OurOld', 'Simple', 'EmuVeto', 'OurNoIso', 'OurMuPrescaled', 'VBTFMuPrescaled']
        self.cutsets = ['Our2016','Our2018','Our2012']#, 'Simple']
...
#            return 5
    ...
    def get_x_axis_range(self, cutset, dilepton, quantity_to_compare):
        ...
        elif quantity_to_compare in ['LeptonPt']:
            return 0, 2000
...
#        if quantity_to_compare != 'DimuonMassVtxConstrainedLog':
    ...
    def go(self):
        for quantity_to_compare in self.quantities_to_compare:
            ...
            if quantity_to_compare != 'DileptonMass':
                cutsets = ['Our2012','Our2016','Our2018']#['OurNew', 'Our2012', 'OurMuPrescaledNew', 'OurMuPrescaled2012']
            else:
