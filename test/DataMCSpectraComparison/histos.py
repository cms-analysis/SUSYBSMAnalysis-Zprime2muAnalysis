...
'''
    ...
    if 'no_data' not in sys.argv:
        ...
        dataset_details = [
			...
			('SingleMuRun2012A_Prompt_192258_193473', '/SingleMu/kypreos-datamc_SingleMuRun2012A_Prompt_192258_193557_20120511152623-f1c162e9ac6a53572830a92e8730d513/USER'),
            ]
