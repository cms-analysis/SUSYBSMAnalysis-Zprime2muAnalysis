...
samples = [
    sample('zmumu',        '#gamma/Z #rightarrow #mu^{+}#mu^{-}',                '/DYToMuMu_M-20_CT10_TuneZ2_7TeV-powheg-pythia/Fall10-START38_V12-v1/GEN-SIM-RECO',          1998931, 432, 0.05, 1631 - 0.97*1.3, hlt_process_name='HLT'),
    sample('dy200',        'DY200',                                              '/DYToMuMu_M-200_7TeV-pythia6/Fall10-START38_V12-v1/GEN-SIM-RECO',                             55000, 433, 0.05, 0.97  - 0.027, k_factor=1.3, hlt_process_name='HLT'),
    sample('dy500',        'DY500',                                              '/DYToMuMu_M-500_7TeV-pythia6/Fall10-START38_V12-v1/GEN-SIM-RECO',                             55000, 434, 0.05, 0.027 - 0.003, k_factor=1.3, hlt_process_name='HLT'),
    sample('dy800',        'DY800',                                              '/DYToMuMu_M-800_7TeV-pythia6/Fall10-START38_V12-v1/GEN-SIM-RECO',                             55000, 435, 0.05, 0.003,         k_factor=1.3, hlt_process_name='HLT'),
    ...
    sample('ztautau',      'Z #rightarrow #tau^{+}#tau^{-}',                     '/DYToTauTau_M-20_CT10_TuneZ2_7TeV-powheg-pythia-tauola/Fall10-START38_V12-v1/GEN-SIM-RECO', 1994719,  46, 0.05, 1631, hlt_process_name='HLT'),
    sample('wjets',        'W+jets',                                             '/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola/Fall10-START38_V12-v1/GEN-SIM-RECO',               15168266,   3, 0.05,  3.1e4, hlt_process_name='HLT'),
    ...
    sample('zssm750',      'Z\'_{SSM} (750 GeV) #rightarrow #mu^{+}#mu^{-}',     '/ZprimeSSMToMuMu_M-750_7TeV-pythia6/Fall10-START38_V12-v1/GEN-SIM-RECO',                      55000,  38, 0.05,  0.355, k_factor=1.3, hlt_process_name='HLT'),
]
samples.reverse()
