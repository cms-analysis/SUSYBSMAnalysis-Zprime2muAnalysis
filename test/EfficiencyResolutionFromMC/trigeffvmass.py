...
#L1Or.Draw('AP')
#HLTOr.Draw('P same')
Total.GetXaxis().SetRangeUser(80, 3000)
Total.GetYaxis().SetRangeUser(0.90, 1.)
Total.Draw('P same')
#lg.Draw()
t = ROOT.TPaveLabel(0.50, 0.85, 0.90, 0.95, 'CMS Simulation   #sqrt{s} = 8 TeV', 'brNDC')
t.SetTextSize(0.39)
t.SetBorderSize(0)
t.SetFillColor(0)
t.SetFillStyle(0)
...
RecoWrtAccTrig.GetXaxis().SetRangeUser(0, 3000)
RecoWrtAccTrig.GetYaxis().SetRangeUser(0., 1.)
RecoWrtAccTrig.GetYaxis().SetTitleOffset(1.0);
...
lg.AddEntry(fcn, 'fit to a + b/pow(m+c, 3) for m in (200,3000)', 'L')
lg.Draw()
...
s.SetX2NDC(0.92)
s.SetY2NDC(0.59)
t = ROOT.TPaveLabel(0.58, 0.57, 0.86, 0.67, 'CMS Simulation   #sqrt{s} = 8 TeV', 'brNDC')
t.SetTextSize(0.38)
t.SetBorderSize(0)
t.SetFillColor(0)
t.SetFillStyle(0)
...
residuals.GetXaxis().SetRangeUser(0, 3000)
