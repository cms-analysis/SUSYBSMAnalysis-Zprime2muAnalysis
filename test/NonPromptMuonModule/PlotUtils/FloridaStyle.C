void FloridaStyle()
{
  ...
  FloridaStyle->SetCanvasDefW      (550);//FloridaStyle: 550 // tdrStyle:600
  ...
  FloridaStyle->SetPadLeftMargin  ( 0.18);//FloridaStyle: 0.18// tdrStyle:0.13
  FloridaStyle->SetPadRightMargin ( 0.05);//FloridaStyle: 0.05 // tdrStyle:0.15
