...
// Tue Jun 10 06:03:43 2008 by ROOT version 5.18/00
// from TTree myTree/myTree
// found on file: /home/mschen/raid5/CSA07FastSimulationValidation/FullSim100pb/Chowder7/ntuple.root
//////////////////////////////////////////////////////////
...
public :
   ...
   virtual void     Loop(TString  s_output         = "test.root",
			 Long64_t entryToStart     =           0,
			 Long64_t entriesToAnalyze =          -1) {
     printf("s_output = %s, entryToStart = %d, entriesToAnalyze = %d\n",
	    s_output.Data(),(Int_t)entryToStart,(Int_t)entriesToAnalyze);
   };
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/mschen/raid5/CSA07FastSimulationValidation/FullSim100pb/Chowder7/ntuple.root");
      if (!f) {
         f = new TFile("/data/1b/mschen/Chowder8_TxAtLeastOneMuonPtGT20GeV.root");
      }
...
void NtupleBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("genEventFilterEff", &genEventFilterEff, &b_genEventFilterEff);
   ...
   fChain->SetBranchAddress("jetTagDiscriminator", &jetTagDiscriminator, &b_jetTagDiscriminator);
