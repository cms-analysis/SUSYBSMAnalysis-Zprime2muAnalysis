...
config.Site.whitelist = ['T2_US_Nebraska','T2_US_UCSD']
...
#config.Site.storageSite = 'T2_US_Purdue'
config.Site.whitelist = ["T2_US_Caltech", "T2_US_UCSD", "T2_US_Nebraska"]
config.Site.storageSite = 'T3_US_FNALLPC'
config.JobType.maxMemoryMB  = 8000
%s
'''
